...
const methodologySteps = [
  ...
  },
  {
    ...
    description: 'The correlation engine cross-references whale activity data with social sentiment metrics. When both signals align — whales accumulate while sentiment trends positive — the signal confidence score increases. Our Diamond Signal threshold of 85%+ represents high-confidence confluence.',
    details: [
      'Proprietary multi-factor correlation algorithm',
      'Whale + sentiment alignment detection',
      '85%+ threshold for Diamond Signals',
  ...
  useEffect(() => {
    ...
    script.textContent = JSON.stringify({
      ...
      about: {
        ...
        description: 'Signals are generated by cross-referencing on-chain whale transactions with AI-powered social sentiment analysis. The correlation engine requires 85%+ alignment for Diamond Signal designation.'
      }
    })
                ...
                <div>
                  ...
                  <div className="text-text-secondary text-sm space-y-2 leading-relaxed">
                    ...
                    <p>
                      ...
                      but past performance — including Diamond Signals with 85%+ correlation scores —
