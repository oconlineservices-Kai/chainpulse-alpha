module.exports = {
  ...
  },
  {
    ...
    env: {
      ...
      PORT: '3000',
      HOSTNAME: '0.0.0.0',
      AUTH_SECRET: process.env.AUTH_SECRET || process.env.NEXTAUTH_SECRET || 'CHANGE-ME-IN-PRODUCTION',
      AUTH_URL: 'https://chainpulsealpha.com',
      NEXTAUTH_SECRET: process.env.AUTH_SECRET || process.env.NEXTAUTH_SECRET || 'CHANGE-ME-IN-PRODUCTION',
